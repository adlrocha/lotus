...
type FullNodeStruct struct {
	...
	Internal struct {
		...
		SyncSubmitBlock func(p0 context.Context, p1 *types.BlockMsg, p2 []*types.FullBlock) error `perm:"write"`
...
func (s *FullNodeStruct) SyncSubmitBlock(p0 context.Context, p1 *types.BlockMsg, p2 []*types.FullBlock) error {
...
func (s *FullNodeStub) SyncSubmitBlock(p0 context.Context, p1 *types.BlockMsg, p2 []*types.FullBlock) error {
	return ErrNotSupported
}
